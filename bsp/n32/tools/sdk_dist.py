...
def bsp_update_board_kconfig(dist_dir):
    ...
    with open(os.path.join(dist_dir, 'board/Kconfig'), 'w') as f:
        for line in data:
            if line.find('$BSP_DIR/../libraries/n32_drivers/Kconfig') != -1:
                position = line.find('$BSP_DIR/../libraries/n32_drivers/Kconfig')
                line = line[0:position] + '$BSP_DIR/libraries/n32_drivers/Kconfig"\n'
            f.write(line)
